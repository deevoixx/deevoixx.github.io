        ...
        <div class="col-12">
            <form class="m-4" method="post">
                <div class="form-group">
                    ...
                    <input autocomplete="off" name="quizId" readonly="readonly" value="<%= lessonId %>" type="text" id="quizId" class="form-control" aria-describedby="titleHelp">
                    <small id="quizId" class="form-text text-muted">The quiz's ID.</small>
                </div>
                <div class="form-group">
                    ...
                    %>
                        <div class="row mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Choices separated by comma.</small>
                            </div>
                            <div class="form-group">
