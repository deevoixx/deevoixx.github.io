<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpass.aspx.cs" Inherits="HOME.forgotpass" %>
    ...
    <form id="form1" method="post" runat="server">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          ...
          <div class="form-outline mb-3">
              ...
              <asp:TextBox ID="textpass" runat="server" ToolTip="Enter new pass" class="form-control form-control-lg"
              placeholder="Enter new password" type="password">
               </asp:TextBox>
              <input type="checkbox" onclick="myFunction('textpass')">Show</input>
          </div>
             <div class="form-outline mb-3">
               <label class="form-label" for="textpass">Password</label>
              <asp:TextBox ID="confirmpass" runat="server" ToolTip="Confirm pass" class="form-control form-control-lg"
              placeholder="Confirm new password" type="password">
               </asp:TextBox>
              <input type="checkbox" onclick="myFunction('confirmpass')">Show</input>
          </div>
          ...
          <div class="d-flex justify-content-between align-items-center"></div>
              <center>
                 ...
                 class="link-danger">Register</a></p>
                    <p class="small fw-bold mt-2 pt-1 mb-0">already have an account? <a class="link-danger" href="index.aspx">Login</a></p>
                  </div>
              </center>
            </div>
