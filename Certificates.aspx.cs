...
namespace HOME
{
    public partial class Certificates : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                certificatesc++;
                certificates += "<div class = 'category'>" + row + "<hr><div class ='quizTopicSec'><div class=\"swiper\"><div class=\"swiper-wrapper\">";
                ...
                foreach (dynamic rcertificate in finishedCategoriesData)
                {
                    ...
                    if (row == rcertificate.language.ToString())
                    {
                        ...
                        certificates +=
                            $"<div data-bs-toggle='modal' data-bs-target='#lesson-modal'  onclick='setModal(\"{url}\")' class ='swiper-slide p-2 quizTopic' " +
                            "'><div class = 'quizTopicTitle'><i class=\"bi bi-eye-fill\"></i>  " +
