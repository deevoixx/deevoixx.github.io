...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body class="m-2">
        <asp:LinkButton  ID="Back" CssClass="back btn btn-primary rounded-5 text-light" runat="server" Text="Back" OnClick="Back_Click">
            <i class="bi bi-arrow-90deg-left text-light"></i> Back
            </asp:LinkButton >
    <div class="title row pt-5">
    ...
    <div class="row pb-3 m-3">
        <asp:LinkButton  CssClass="btn btn-primary rounded-5 text-light"
                    ID='Button1'
                    class='startButton'
                    runat='server'
                    Text='Start'
